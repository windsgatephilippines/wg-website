            ...
            <div className="container py-5">
                <div className="row g-5">
                    <div className="col-lg-4 col-md-6 text-start">
                        ...
                        <p className="mb-2"><FontAwesomeIcon className='me-3' icon={faLocationDot}/>33E Cebu Exchange Building, Salinas Drive, Lahug, Cebu City</p>
                        <p className="mb-2"><FontAwesomeIcon className='me-3' icon={faPhone}/>+(032) 236-6400</p>
                    ...
                    <div className="col-lg-4 col-md-6">
                        ...
                        <Link className="btn btn-link d-block text-start" href={"/about"}><FontAwesomeIcon className='me-3' icon={faChevronRight}/>About Us</Link>
                        <Link className="btn btn-link d-block text-start" href={"/contact"}><FontAwesomeIcon className='me-3' icon={faChevronRight}/>Contact Us</Link>
                        <Link className="btn btn-link d-block text-start" href={"/services"}><FontAwesomeIcon className='me-3' icon={faChevronRight}/>Our Services</Link>
