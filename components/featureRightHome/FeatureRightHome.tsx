            ...
            <div className="row gy-4">
                ...
                <div className="col-12">
                    <div className="d-flex">
                        ...
                        <div className="ms-4">
                            <h4 className="text-white">Maintain and improve existing application.</h4>
                        </div>
                    </div>
                </div>
                <div className="col-12">
                    <div className="d-flex">
                        ...
                        <div className="ms-4">
                            <h4 className="text-white">Design and update software database.</h4>
                        </div>
                    </div>
                </div>
                <div className="col-12">
                    <div className="d-flex">
                        ...
                        <div className="ms-4">
                            <h4 className="text-white">Test and maintain software products to ensure strong
                                functionality and
                                optimization.</h4>
                        </div>
                    </div>
                ...
                <div className="col-12">
                    <div className="d-flex">
                        ...
                        <div className="ms-4">
                            <h4 className="text-white">Must learn Japanese language provided by the company to be
                                able to develop
                                Japanese localized software.</h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="modal-content rounded-0">
                        ...
                        <div className="modal-body">
                            <div className="ratio ratio-16x9">
                                <iframe className="embed-responsive-item" src="" id="video" allowFullScreen={true}
